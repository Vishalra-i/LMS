    ...
    <div className="min-h-full">
      ...
      <div className="drawer absolute z-50 left-0 w-fit">
        ...
        <div className="drawer-side w-0">
          ...
          <ul className="menu p-4 w-48 sm:w-80 bg-black font-semibold text-base-content relative">
      ...
      {/* Add Profile in circle  */}
      <div className="absolute z-50 right-2 top-2 w-fit">
         <Link to={"/user/profile"}>
            <img src={isLoggedIn ? `${userData?.avatar?.secure_url}` : "https://res.cloudinary.com/du9jzqlpt/image/upload/v1674647316/avatar_drzgxv.jpg"} className="rounded-full w-12 h-12" alt="profile" />
         </Link>
      </div>
